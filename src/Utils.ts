export class Utils {
    ...
    static getProjection(angle: number, a: number, zMin: number, zMax: number) {
    ...
    static getProjectionOrtho(width: number, a: number, zMin: number, zMax: number) {
    ...
    static translateX(m: number[], t: number) {
        m[12] += t;
    }
